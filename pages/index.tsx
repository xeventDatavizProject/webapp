      ...
      <div className="container">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="mx-auto">
            <Image src={MonitorImg} alt="monitor_image" />
          </div>
          <div>
            ...
            <Paragraph>
              Le lorem ipsum est, en pour calibrer Le lorem ipsum est, en
              imprimerie, une suite de s sans signification utilisée à titre
              provisoire pour calibrer Le lorem ipsum Le lorem ipsum est, en
              pour calibrer Le lorem ipsum est, en imprimerie, une suite de s
              sans signification utilisée à titre provisoire pour calibrer Le
              lorem ipsum
            </Paragraph>
          </div>
        </section>
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-20 items-center">
          <div>
            <Title as="h3" size="sm" className="mb-4">
              Prevent errors
            </Title>
          ...
          <div className="mx-auto">
            <Image src={PerformanceImg} alt="performance_image" />
          </div>
        </section>
      </div>
    </Layout>
