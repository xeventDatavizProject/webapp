      ...
      <div className='container'>
        ...
        <div>
          ...
          <div className='flex flex-wrap'>
            ...
            <div className='block m-8 w-full px-4 flex-1 h-full'>
              <div className='flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4 h-2/4'>
                <Image
                  priority
              ...
              <h1 className='flex flex-col h-4/6 m-6 text-lg'>
                <span className='mx-auto'>HANNA Filoupatir</span>
              </h1>
              <div className='flex justify-between items-center'>
                <div className='flex flex-col text-base'>
                  <span className='mx-auto'>Développeur BackEnd</span>
                </div>
                <Image
                  priority
            ...
            <div className='block m-8 w-full px-4 flex-1 h-full'>
              ...
              <h1 className='flex flex-col h-4/6 m-6 text-lg'>
                <span className='mx-auto'>BISSICK James</span>
              </h1>
              <div className='flex justify-between items-center'>
                <div className='flex flex-col text-base'>
                  <span className='mx-auto'>Développeur BackEnd</span>
            ...
            <div className='block my-8 w-full px-4 flex-1 h-full'>
              <div className='flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4 h-2/4'>
                <Image
                  priority
                  src='/assets/images/user.png'
              ...
              <h1 className='flex flex-col h-4/6 m-6 text-lg'>
                <span className='mx-auto'>EL MOUTII Issam</span>
              </h1>
              <div className='flex justify-between items-center'>
                <div className='flex flex-col text-base'>
                  <span className='mx-auto'>Développeur BackEnd</span>
            ...
            <div className='block my-8 w-full px-4 flex-1 h-full'>
              ...
              <h1 className='flex flex-col h-4/6 m-6 text-lg'>
                <span className='mx-auto'>N'DOLO-NZAMBA Merith-Magni</span>
              </h1>
              <div className='flex justify-between items-center'>
                <div className='flex flex-col text-base'>
                  <span className='mx-auto'>Développeur FullStack</span>
                </div>
                <Image
                  priority
                  src='/assets/images/linkedin.png'
          ...
          <div className='flex flex-wrap'>
            ...
            <div className='block my-8 w-full px-4 flex-1 h-full'>
              ...
              <h1 className='flex flex-col h-4/6 m-6 text-lg'>
                <span className='mx-auto'>MAHFOUFI Chabha</span>
              </h1>
              <div className='flex justify-between items-center'>
                <div className='flex flex-col text-base'>
                  <span className='mx-auto'>Développeur FrontEnd</span>
                </div>
                <Image
                  priority
                  src='/assets/images/linkedin.png'
            ...
            <div className='block my-8 w-full px-4 flex-1 h-full'>
              ...
              <h1 className='flex flex-col h-4/6 m-6 text-lg'>
                <span className='mx-auto'>POKAM Joël</span>
              </h1>
              <div className='flex justify-between items-center'>
                <div className='flex flex-col text-base'>
                  <span className='mx-auto'>Développeur FrontEnd</span>
            ...
            <div className='block my-8 w-full px-4 flex-1 h-full'>
              ...
              <h1 className='flex flex-col h-4/6 m-6 text-lg'>
                <span className='mx-auto'>BATONON Dylan</span>
              </h1>
              <div className='flex justify-between items-center'>
                <div className='flex flex-col text-base'>
                  <span className='mx-auto'>Développeur FrontEnd</span>
            ...
            <div className='block my-8 w-full px-4 flex-1 h-full'>
              ...
              <h1 className='flex flex-col  justify-center h-4/6 mb-6 text-lg'>
                <span className='mx-auto'>TAING Dorian</span>
              </h1>
              <div className='flex justify-between items-center'>
                <div className='flex flex-col text-base'>
                  <span className='mx-auto'>Développeur FrontEnd</span>
