      ...
      <div className="container">
        <div className="flex flex-col lg:flex-row">
          <div className="w-full px-4 flex-1">
            <h1 className="my-8 tracking-[2px] text-4xl font-large mb-2 items-center">
              Surveiller votre base de données en temps réel
            </h1>
            <p className="mx-auto my-8 text-lg">
              XDA est une interface qui vous propose plusieurs solutions pour
              les devops et aussi aux développeurs. Elle vous permet de
              surveiller votre BD et d'être alerté en cas de baisse de
              performances ou d’anomalies. Il vous offre aussi une meilleure
              visualisation de données à travers des graphiques
            </p>
            <div className="flex flex-col md:flex-row justify-end items-center space-y-4 md:space-y-0 md:space-x-4">
              ...
              <Button className="bg-blue-200 bg-opacity-40 font-extralight">
                Demander la demo
              </Button>
            </div>
          </div>
        ...
        <div className="my-8 flex flex-wrap md:my-8 pt-12">
          <p className="mx-auto md:my-8 text-lg">
            De plus que les alertes, XDA vous offre une meilleur visualisation
            sur vous données en proposant un dashboard avec différents
            graphiques. Elle vous permet de surveiller votre BD, d'être alerté
            en cas de baisse de performances ou d’anomalies et identifier et
            comprendre la lenteur des requêtes (informations sur les différents
            services).
          </p>
          <div className="relative grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-16 md:gap-4 max-w-5xl mx-auto px-5 mb-12 md:mb-20">
            <div className="px-4 flex-1">
              ...
              <p className="flex flex-col h-4/6">
                <span className="mx-auto">
                  Visualiser les requêtes les plus fréquentes
                </span>
              </p>
            </div>

            <div className="my-8 px-4 flex-1">
              <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4 h-2/4">
                <Image
                  priority
              ...
              <h1 className="flex flex-col h-4/6">
                <span className="mx-auto">
                  Visualiser les erreurs ou les requêtes qui ne marchent pas
                </span>
              </h1>
            </div>
            <div className="my-8 px-4 flex-1">
            ...
            <div className="my-8 px-4 flex-1">
              ...
              <div className="h-2/4">
                <h1 className="flex flex-col">
                  <span className="mx-auto">
                    Qui sont les utilisateurs qui consomment le plus{" "}
                  </span>
                </h1>
              </div>
            </div>
            <div className="my-8 px-4 flex-1">
              ...
              <div className="h-2/4">
                <h1 className="flex flex-col h-50-px">
                  <span className="mx-auto">
                    Pic d’utilisation (horaires de surcharge)
                  </span>
                </h1>
              </div>
            </div>
        ...
        <div>
          ...
          <div className="my-8 relative grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-16 md:gap-4 max-w-5xl mx-auto px-5 mb-12 md:mb-20">
            <div className="my-8 w-full px-4 flex-1 h-full">
              <h1 className="flex flex-col mb-6 text-lg">
            ...
            <div className="my-8 w-full px-4 flex-1 h-full">
              <h1 className="flex flex-col mb-6 text-lg">
                <span className="mx-auto">VScode</span>
              </h1>
              <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4 h-2/4">
                <Image
                  priority
